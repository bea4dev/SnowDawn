...
enum class Text(val jp: String) {
    ...
    CREDIT_SCENARIO_AND_WORLD("シナリオ・世界観"),
    CREDIT_DEVELOPMENT("開発"),
    CREDIT_MODELING("モデリング"),
    CREDIT_INTERNAL_PLUGINS("プラグイン（内部）"),
    CREDIT_EXTERNAL_PLUGINS("プラグイン（外部）"),
    CREDIT_SERVER_PLATFORM("サーバー基盤"),
    CREDIT_LEVEL_DESIGN("建築・レベルデザイン"),
    CREDIT_MINECRAFT("その他・Minecraft"),
    CREDIT_BEA4DEV("bea4dev (_Be4_)"),
    CREDIT_INTERNAL_PLUGIN_NAMES("VanillaSource, SnowDawn"),
    CREDIT_EXTERNAL_PLUGIN_NAMES("WorldEdit, ModelEngine"),
    CREDIT_CHIYOGAMI("Chiyogami"),
    CREDIT_MOJANG_STUDIOS("Mojang Studios"),
    CREDIT_THANK_YOU("Thank you for playing!"),
    ...
    ITEM_WEAPON_ATTACK_DAMAGE("攻撃力: {0}"),
